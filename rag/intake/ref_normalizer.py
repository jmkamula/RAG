...
DOC_TYPE_CLAUSE_MAP = {
    "policy": {
        ...
        # 27701's curated Annex A (§A.7.x) + Annex B (§B.8.x). Older values
        # ["6", "7", "8"] never matched because 27701 refs start with
        # "A.7." or "B.8." — startswith("6") failed for every leaf.
        "ISO27701:2019": ["A.7", "B.8"],
    },
    "procedure": {
    ...
    "agreement_template": {
        "ISO27001:2022": ["A.5.19", "A.5.20"],
        "GDPR:2016/679": ["Art.28"],
        "ISO27701:2019": ["A.7.2.6", "B.8.2.1", "B.8.5.6", "B.8.5.7", "B.8.5.8"],
    },
    "privacy_notice": {
        "ISO27001:2022": ["A.5.34"],
        "GDPR:2016/679": ["Art.13", "Art.14"],
        "ISO27701:2019": ["A.7.3.2", "A.7.3.3"],
    },
    "risk_assessment": {
        "ISO27001:2022": ["6.1", "A.8"],
        "GDPR:2016/679": ["Art.32", "Art.35"],
        "ISO27701:2019": ["A.7.2.5"],
    },
    "plan": {
        "ISO27001:2022": ["A.5.29", "A.5.30", "6.1"],
        "ISO27701:2019": ["A.7"],
    },
    "scope_note": {
        "ISO27001:2022": ["4.3"],
