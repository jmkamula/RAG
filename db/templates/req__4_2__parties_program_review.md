...
## 3. Register currency check — every party row reviewed for continued relevance, new parties added
...
## 4. Requirements currency check — regulator updates, contract amendments swept in
...
## 5. Cross-check against the applicable-domains scope — any new category that should be covered
