...
## 2. Reviewer identity (Chief Architect + Security Architect + InfoSec)
...
## 3. Principle-set review (new threats → new principles; obsolete principles retired)
...
## 4. Reference-pattern currency check (no abandoned patterns; new technology patterns added)
...
## 5. Findings propagated to policy / register
