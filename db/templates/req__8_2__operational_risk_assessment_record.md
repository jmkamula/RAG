...
## 2. Significant-change trigger for ad-hoc reassessments documented
...
## 3. Last assessment date recorded
...
## 4. Criteria from 6.1.2 a) applied during assessment
...
## 5. Results documented and retained
...
## 6. Per-assessment owner (Risk Manager or function risk-owner)
...
### 1. Comparison or movement from prior assessment
