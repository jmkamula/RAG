...
## 2. Audience reached (all personnel, including contractors and third parties in scope)
...
## 3. Channel used (all-hands briefing, intranet publication, manager cascade, training module)
...
## 4. Distribution at onboarding for new personnel evidenced (induction pack, mandatory module)
...
### 1. Personnel acknowledgement captured (signature, e-attestation, training completion)
...
### 2. Periodic re-acknowledgement referenced (annual at minimum)
