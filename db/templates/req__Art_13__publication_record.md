...
## 2. Per-row publication location (URL, app screen, signup flow)
...
## 3. Per-row effective date stated
...
## 4. Per-row approval (DPO / Privacy Lead sign-off)
...
## 5. Prior versions retained for audit (proves what subjects saw at the time of collection)
...
### 1. Per-row change-summary annotation (what changed vs prior version)
