...
## 2. Reviewer identity (DPO + procurement / data-acquisition lead)
...
## 3. Register currency check — every active third-party source has a current row
...
## 4. Deadline compliance audit — notice deadlines met per Art.14.3
...
## 5. Art.14.5 exception re-assessment — exceptions claimed still hold (proportionate-impossibility may change)
