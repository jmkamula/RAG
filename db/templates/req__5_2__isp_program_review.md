...
## 3. Policy currency check — still appropriate to organisational purpose and scope
...
## 4. Approval currency check — signed by current top management
...
## 5. Communication completeness check — required audience is covered and current
