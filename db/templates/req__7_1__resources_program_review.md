...
## 2. Reviewer identity (ISMS Manager + finance partner + top management)
...
## 3. Adequacy check — resources actually provided match the determined need per category
...
## 4. Gap response — any under-resourcing surfaced with remediation plan
