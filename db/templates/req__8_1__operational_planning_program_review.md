...
## 2. Reviewer identity (ISMS Manager + ops lead)
...
## 3. Execution completeness check — every scheduled process iteration logged
...
## 4. Outsourced oversight check — every outsourced process has current supplier-side evidence (A.5.19/A.5.20)
...
## 5. Clause 6 handoff check — every 6.1.1 planned action reached operational implementation OR was deferred
