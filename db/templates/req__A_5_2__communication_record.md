...
## 2. Audience reached (all staff or named role-holders)
...
## 3. Channel used (intranet publication, email, training session, onboarding pack)
...
### 1. Role-specific briefing or acknowledgement from named role-holders (CISO, asset owners, etc.)
...
### 2. Communication built into joiner onboarding so new role-holders are briefed on appointment
