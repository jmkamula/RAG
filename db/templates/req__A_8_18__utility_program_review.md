...
## 2. Reviewer identity (InfoSec + Infrastructure)
...
## 3. Authorised-user list re-confirmed per utility
...
## 4. Removal-where-unneeded sweep (utilities found in unauthorised locations)
...
## 5. Findings propagated to register / scope
