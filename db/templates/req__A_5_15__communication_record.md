...
## 2. Audience reached (decision-makers — managers, system owners, IT admins — plus all access-holders)
...
## 3. Channel used (manager briefing, IT admin training, intranet publication)
...
## 4. Decision-maker awareness specifically captured (manager training, system-owner briefing)
...
## 5. Onboarding coverage — new managers and admins receive the policy as part of role induction
...
### 1. Periodic refresher referenced (annual at minimum)
...
### 2. Tie-in with A.5.18 provisioning training — decision-makers know both the rules and the workflow
