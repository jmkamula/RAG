...
## 2. Signed by current top management (covers turnover)
...
## 3. Evidence packet for the period (board minutes excerpt, sponsor signoffs, mgmt review attendance)
...
## 4. Next reaffirmation due date stated
...
### 1. Trigger captured if mid-cycle (CEO change, major incident, restructuring)
