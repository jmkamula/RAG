...
## 2. Reviewer identity (ISMS Manager + top management)
...
## 3. Currency check — scope still matches organisational reality (sites, products, third parties)
...
## 4. Cross-check against change records — every actual scope change in the year is logged
