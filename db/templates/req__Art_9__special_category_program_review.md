...
## 3. Register currency check — every active activity has its Art.9.2 condition still appropriate
...
## 4. Safeguards audit — Art.9.3 secrecy obligations being enforced (where Art.9.2.h-i applies)
...
## 5. Silent-onboarding sweep — verify no new special-category data ingested without the procedure being invoked
