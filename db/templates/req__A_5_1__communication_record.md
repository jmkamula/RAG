...
## 2. Audience reached (all staff, scoped subset, or named groups)
...
## 3. Channel used (intranet publication, email, training session, town hall)
...
### 1. Acknowledgment of receipt and understanding by personnel (e.g. signed register, e-learning completion)
...
### 2. Communication to relevant interested parties (contractors, suppliers) where appropriate
