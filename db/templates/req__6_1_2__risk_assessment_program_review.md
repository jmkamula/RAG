...
## 3. Register currency check — every row reviewed for continued relevance
...
## 4. Methodology fit check — scoring scale still discriminating, acceptance bands still calibrated
...
## 5. Significant-change trigger sweep — 8.2 ad-hoc assessments captured
