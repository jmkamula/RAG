...
## 2. Audience reached (affected role-holders or all relevant function leads)
...
## 3. Channel used (intranet publication, role-holder briefing, manager cascade)
...
### 1. Linkage into A.6.4 disciplinary process — non-compliance with separation has stated consequence
...
### 2. Communication built into onboarding for new role-holders in affected positions
